...
const items1: item[] = [
  ...
  { id: 5, label: "Môi", image: require("../../assets/images/flow2/moi.png") },
  {
    id: 6,
    label: "Răng",
    image: require("../../assets/images/flow2/rang.png"),
  },
  {
    id: 7,
    label: "Miệng",
    image: require("../../assets/images/flow2/mieng.png"),
  },
  {
    id: 8,
    label: "Bàn tay",
  ...
  { id: 10, label: "Vai", image: require("../../assets/images/flow2/vai.png") },
  {
    id: 11,
    label: "Lưng",
    image: require("../../assets/images/flow2/lung.png"),
  },
  {
    id: 12,
    label: "Bụng",
    image: require("../../assets/images/flow2/bung.png"),
  },
  {
    id: 13,
    label: "Đầu gối",
